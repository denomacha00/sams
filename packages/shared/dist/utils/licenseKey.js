...
exports.encodeLicenseKey = encodeLicenseKey;
exports.decodeLicenseKey = decodeLicenseKey;
 ...
 */
function encodeLicenseKey(payload, secret) {
    // Generate 8 random hex characters as a nonce for uniqueness
    const nonce = (0, crypto_1.randomBytes)(4).toString('hex').toUpperCase();
...
function decodeRawLicenseToken(stripped, secret) {
    ...
    try {
        ...
        const validTiers = Object.values(index_1.PlanTier);
