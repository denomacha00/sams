...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        card: '0 10px 26px -24px rgb(37 99 235 / 0.34), 0 1px 2px -1px rgb(15 23 42 / 0.18)',
        'card-hover': '0 18px 38px -28px rgb(37 99 235 / 0.42), 0 3px 10px -8px rgb(15 23 42 / 0.25)',
        'card-soft': '0 12px 28px -25px rgb(37 99 235 / 0.36), 0 1px 0 rgb(255 255 255 / 0.035) inset',
        'card-soft-hover': '0 18px 42px -30px rgb(37 99 235 / 0.46), 0 1px 0 rgb(255 255 255 / 0.045) inset',
      },
    },
  },
  plugins: [],
