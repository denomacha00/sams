    ...
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center px-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="surface-card rounded-2xl shadow-2xl p-8">
          ...
          {/* Success state */}
          {success && (
            <div className="mb-6 p-4 bg-indigo-500/20 border border-indigo-400/30 rounded-xl backdrop-blur-sm text-center">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-indigo-500/30 mb-3">
                <svg className="w-6 h-6 text-indigo-300 animate-[bounce_1s_ease-in-out]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="bg-indigo-500/10 border border-indigo-400/20 rounded-lg px-3 py-2 inline-block">
                <p className="text-xs text-indigo-300/70 uppercase tracking-wider">Your School Code</p>
                <p className="text-lg font-bold text-indigo-100 tracking-widest">{activatedSchoolCode}</p>
              </div>
