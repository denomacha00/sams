    ...
    <div className="page-shell p-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-ink-muted text-sm mt-1">Manage your security and preferences</p>
        </div>
        ...
        <div className="mb-4">
          ...
          <p className="text-xs text-ink-subtle mt-1">Manage your password and authentication</p>
        </div>
        ...
        <div className="surface-card rounded-2xl p-6 mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-xs text-ink-muted">Update your account password</p>
            </div>
          </div>
        ...
        {(webauthnAvailable || isStudent) && (
          <div className="mb-4">
            ...
            <p className="text-xs text-ink-subtle mt-1">Fingerprint and face recognition settings</p>
          </div>
        )}
        ...
        {webauthnAvailable && (
          <div className="surface-card rounded-2xl p-6 mb-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-ink">Fingerprint Sign-In</h3>
        ...
        {canSend && (
          <>
            <div className="mb-4 mt-2">
              ...
              <p className="text-xs text-ink-subtle mt-1">Manage messages you've sent</p>
            </div>
            ...
            <div className="surface-card rounded-2xl p-6 mb-6">
              {sentLoading ? (
                ...
                <p className="text-sm text-ink-subtle text-center py-6">No sent notifications yet.</p>
              ) : (
