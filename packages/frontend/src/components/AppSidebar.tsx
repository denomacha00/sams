...
const ICONS: Record<string, string> = {
  ...
  scheme: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z',
...
const TEACHER_ITEMS: SidebarItem[] = [
  { label: 'Scheme of Work', path: '/schemes', icon: 'scheme' },
...
const HOD_ITEMS: SidebarItem[] = [
  ...
  { label: 'Teacher Units', path: '/admin/teacher-subjects', icon: 'exams' },
...
function groupItems(items: SidebarItem[]): CategoryGroup[] {
  ...
  const academicItems = other.filter((i) =>
    ['exams', 'risk', 'knowledge', 'scheme'].includes(i.icon)
  );
