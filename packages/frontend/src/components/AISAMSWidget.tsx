  ...
  return (
    <>
      ...
      <div
        ...
        } w-[calc(100vw-2rem)] sm:w-[400px] h-[500px] max-h-[70vh] flex flex-col rounded-2xl border border-slate-700 backdrop-blur-xl bg-slate-950/95 shadow-2xl shadow-black/30`}
      >
        {/* Header */}
        <div className="flex items-center justify-between px-4 py-3 border-b border-slate-700 bg-slate-900 rounded-t-2xl">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-indigo-300/70">Smart Assistant</p>
            </div>
          </div>
          <button
            ...
            <div className="flex flex-wrap gap-1.5 pt-1">
              {QUICK_QUESTIONS.map((q) => (
                <button
                  ...
                  className="px-2.5 py-1.5 bg-indigo-500/10 border border-indigo-500/30 rounded-lg text-xs text-indigo-300 hover:bg-indigo-500/20 transition-all duration-200"
                >
                  {q}
                </button>
              ))}
        ...
        <div className="border-t border-white/10 p-3">
          <form onSubmit={handleSubmit} className="flex gap-2">
            <input
              ...
              disabled={loading}
              className="flex-1 bg-slate-900 border border-slate-700 rounded-lg px-3 py-2 text-sm text-white placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-indigo-500/40 disabled:opacity-50 transition-all"
            />
            ...
            <button
              ...
              className={`p-2 rounded-lg transition-all duration-200 ${
                isListening
                  ...
                  : 'bg-slate-900 text-gray-400 border border-slate-700 hover:bg-slate-800 hover:text-white'
              }`}
