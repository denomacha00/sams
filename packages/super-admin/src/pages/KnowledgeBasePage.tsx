            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-700">
                  ...
                  <th className="text-left px-6 py-3 text-xs font-medium text-gray-400 uppercase tracking-wider">Content Preview</th>
                  <th className="text-left px-6 py-3 text-xs font-medium text-gray-400 uppercase tracking-wider">Updated</th>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-sm rounded-xl border border-gray-700 bg-gray-800 shadow-2xl p-6">
            ...
            <p className="text-sm text-gray-300 mb-6">
              ...
              <span className="font-semibold text-white">"{deleteTarget.title}"</span>? This cannot be undone.
            </p>
